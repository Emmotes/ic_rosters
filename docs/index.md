...
<span class="eventRosterChampion eventBuffsTooltipHolder" id="dynaheir" style="background-image:url(images/portraits/dynaheir.png)">Dynaheir (3)<span class="eventBuffsTooltipContents"><strong>Event Buff Tiers:</strong><br><ol><li>All Champions damage +200%.</li><li>Increases the effect of Dynaheir's specializations by 400%. (Prestack)</li><li>Increases the effect of Dynaheir's Defensive Position ability by 2400%.</li><li>Increases the effect of Dynaheir's The Resolve of Rashemen ability by 6300%.</li></ol><br><strong>Event Reward Tiers:</strong><br>Unknown.</span></span>
...
<span class="eventRosterChampion eventBuffsTooltipHolder" id="raistlin" style="background-image:url(images/portraits/raistlin.png)">Raistlin (2)<span class="eventBuffsTooltipContents"><strong>Event Buff Tiers:</strong><br>Unknown.<br><br><strong>Event Reward Tiers:</strong><br>Unknown.</span></span>
</span>
