...
<span class="eventRosterChampion eventBuffsTooltipHolder" id="tasslehoff" style="background-image:url(images/portraits/tasslehoff.png)">Tasslehoff (11)<span class="eventBuffsTooltipContents"><strong>Event Buff Tiers:</strong><br>Unknown.<br><br><strong>Event Reward Tiers:</strong><br>Unknown.</span></span>
</span>
