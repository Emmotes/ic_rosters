...
<span class="eventRosterChampion eventBuffsTooltipHolder" id="laurana" style="background-image:url(images/portraits/laurana.png)">Laurana (7)<span class="eventBuffsTooltipContents"><strong>Event Buff Tiers:</strong><br>Unknown.<br><br><strong>Event Reward Tiers:</strong><br>Unknown.</span></span>
</span>
