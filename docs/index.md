...
<span class="eventRosterChampion eventBuffsTooltipHolder" id="lazaapz" style="background-image:url(images/portraits/lazaapz.png)">Lazaapz (9)<span class="eventBuffsTooltipContents"><strong>Event Buff Tiers:</strong><br><ol><li>All Champions damage +200%.</li><li>Increases the health of Lazaapz by 400%.</li><li>Increases the effect of Lazaapz's Tiny Bulwark ability by 2400%.</li><li>Increases the effect of Lazaapz's Fury of the Small ability by 6300%.</li></ol><br><strong>Event Reward Tiers:</strong><br>Nothing.</span></span>
